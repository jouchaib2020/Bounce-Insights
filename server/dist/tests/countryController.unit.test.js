...
const mockFetch = (0, utils_1.mocked)(node_fetch_1.default, true);
describe('getCountryByName', () => {
    ...
    it('should fetch country by name successfully', async () => {
        ...
        expect(mockResponse.send).toHaveBeenCalledWith((0, utils_2.mapCountryToCountryResponse)(mockCountry[0]));
    });
